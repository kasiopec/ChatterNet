package project5.chatternet.routing;
...
import project5.chatternet.MainActivity;
import project5.chatternet.data.ChatMessage;
import project5.chatternet.data.ChatStorage;
import project5.chatternet.data.Note;
import project5.chatternet.data.NoteStorage;
import project5.chatternet.messages.MessageIntent;
import project5.chatternet.messages.RoutedMessage;
import project5.chatternet.services.BluetoothSettings;
import project5.chatternet.services.BluetoothSocketDevice;
import project5.chatternet.services.DeviceType;
import aau.semester5.project.R;
...
public abstract class IRoutingProtocol {
	...
	/**
	 * Processes an intent that is sent over the meshnetwork. This can be overriden to
	 * handle more intents. Make sure to call super.processIntent() after
	 * your own processing
	 *  message
	 */
